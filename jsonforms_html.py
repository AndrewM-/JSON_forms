...
def write_file(t):
    f = open("C:/Temp/demofile5.html", "w")
    f.write(t)
    f.close()

def open_db():
    dbfile = "F:/Temp/2024-06-24_QgisPythonScripts/Geopaparazzi/smash_export_20240614_131146.gpkg"
...
remove_file("C:/Temp/demofile5.html")
